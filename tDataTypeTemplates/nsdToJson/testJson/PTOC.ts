...
export const ptoc = {
  ...
  MinOpTmms: {
    ...
    type: "ING",
    descID:
      "IEC61850_7_4.AbstractLNsGroupP::CurrentProtectionLN.MinOpTmms.desc",
    presCond: "O",
    dsPresCond: "F",
  ...
  MaxOpTmms: {
    ...
    type: "ING",
    descID:
      "IEC61850_7_4.AbstractLNsGroupP::CurrentProtectionLN.MaxOpTmms.desc",
    presCond: "O",
    dsPresCond: "F",
    children: ingChildren,
  },
      ...
      setVal: {
        ...
        children: {
          ...
          "Definite Time Delayed Reset": {
            tagName: "Literal",
            name: "Definite Time Delayed Reset",
            literalVal: "2",
          },
          "Inverse Reset": {
            tagName: "Literal",
