...
export const fpid = {
  ...
  PAct: {
    ...
    presCondArgs: "1",
    presCondArgsID:
      "IEC61850_7_4.LNGroupF::FPID__(_OFcond(1)_=__((_PAct_))__)_.cond.LNGroupF::FPID.PAct",
    dsPresCond: "O",
    children: mvChildren,
  },
  IAct: {
    ...
    presCondArgs: "2",
    presCondArgsID:
      "IEC61850_7_4.LNGroupF::FPID__(_OFcond(2)_=__((_IAct_))__)_.cond.LNGroupF::FPID.IAct",
    dsPresCond: "O",
    children: mvChildren,
  },
  DAct: {
    ...
    presCondArgs: "3",
    presCondArgsID:
      "IEC61850_7_4.LNGroupF::FPID__(_OFcond(3)_=__((_DAct_))__)_.cond.LNGroupF::FPID.DAct",
    dsPresCond: "O",
    children: mvChildren,
  },
  ErrTerm: {
  ...
  KP: {
    ...
    presCondArgs: "1",
    presCondArgsID:
      "IEC61850_7_4.LNGroupF::FPID__(_MFcond(1)_=__((_KP_))__)_.cond.LNGroupF::FPID.KP",
    dsPresCond: "F",
  ...
  KI: {
    ...
    presCondArgs: "2",
    presCondArgsID:
      "IEC61850_7_4.LNGroupF::FPID__(_MFcond(2)_=__((_KI,_ITmms_))__)_.cond.LNGroupF::FPID.KI",
    dsPresCond: "F",
    children: asgChildren,
  },
  ITmms: {
    ...
    presCondArgs: "2",
    presCondArgsID:
      "IEC61850_7_4.LNGroupF::FPID__(_MFcond(2)_=__((_KI,_ITmms_))__)_.cond.LNGroupF::FPID.ITmms",
    dsPresCond: "F",
    children: ingChildren,
  },
  KD: {
    ...
    presCondArgs: "3",
    presCondArgsID:
      "IEC61850_7_4.LNGroupF::FPID__(_MFcond(3)_=__((_KD,_DTmms,_DFilTmms_))__)_.cond.LNGroupF::FPID.KD",
    dsPresCond: "F",
    children: asgChildren,
  },
  DTmms: {
    ...
    presCondArgs: "3",
    presCondArgsID:
      "IEC61850_7_4.LNGroupF::FPID__(_MFcond(3)_=__((_KD,_DTmms,_DFilTmms_))__)_.cond.LNGroupF::FPID.DTmms",
    dsPresCond: "F",
    children: ingChildren,
  },
  DFilTmms: {
    ...
    presCondArgs: "3",
    presCondArgsID:
      "IEC61850_7_4.LNGroupF::FPID__(_MFcond(3)_=__((_KD,_DTmms,_DFilTmms_))__)_.cond.LNGroupF::FPID.DFilTmms",
    dsPresCond: "F",
    children: ingChildren,
  },
  Bias: {
