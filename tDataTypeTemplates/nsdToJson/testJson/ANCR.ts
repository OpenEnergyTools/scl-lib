      ...
      stVal: {
        ...
        children: {
          ...
          "Tuned but not compensated": {
            tagName: "Literal",
            name: "Tuned but not compensated",
            literalVal: "3",
          },
          Umax: {
            tagName: "Literal",
          ...
          "Umax but not compensated": {
            tagName: "Literal",
            name: "Umax but not compensated",
            literalVal: "5",
          },
          "Umax but not compensated due to U continous limitation": {
            tagName: "Literal",
            name: "Umax but not compensated due to U continous limitation",
            literalVal: "6",
          },
        },
      },
      ...
      setVal: {
        ...
        children: {
          ...
          "Master/Slave with fixed slave position": {
            tagName: "Literal",
            name: "Master/Slave with fixed slave position",
            literalVal: "2",
          },
          "Master/Slave with variable slave position": {
            tagName: "Literal",
            name: "Master/Slave with variable slave position",
            literalVal: "3",
          },
          "Parallel operation without communication": {
            tagName: "Literal",
            name: "Parallel operation without communication",
            literalVal: "4",
          },
        },
      },
