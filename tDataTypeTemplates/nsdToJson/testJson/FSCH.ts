  ...
  SchdEnaErr: {
    ...
    children: {
      stVal: {
        ...
        mandatory: true,
        presCond: "M",
        type: "ScheduleEnablingErrorKind",
        children: {
          None: {
            tagName: "Literal",
            name: "None",
          ...
          "Missing valid NumEntr": {
            tagName: "Literal",
            name: "Missing valid NumEntr",
            literalVal: "2",
          },
          "Missing valid SchdIntv": {
            tagName: "Literal",
            name: "Missing valid SchdIntv",
            literalVal: "3",
          },
          "Missing valid schedule values": {
            tagName: "Literal",
            name: "Missing valid schedule values",
            literalVal: "4",
          },
          "Inconsistent values CDC": {
            tagName: "Literal",
            name: "Inconsistent values CDC",
            literalVal: "5",
            descID:
              "IEC61850_7_4.DOEnums::ScheduleEnablingErrorKind.Inconsistent_values_CDC.desc",
          },
          "Missing valid StrTm": {
            tagName: "Literal",
            name: "Missing valid StrTm",
            literalVal: "6",
            descID:
              "IEC61850_7_4.DOEnums::ScheduleEnablingErrorKind.Missing_valid_StrTm.desc",
          },
          Other: {
            tagName: "Literal",
            name: "Other",
