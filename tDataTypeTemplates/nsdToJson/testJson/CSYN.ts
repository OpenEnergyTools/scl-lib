  ...
  LivDeaMod: {
    ...
    children: {
      setVal: {
        ...
        mandatory: true,
        presCond: "M",
        type: "LiveDeadModeKind",
        children: {
          "Dead Line, Dead Bus": {
            tagName: "Literal",
            name: "Dead Line, Dead Bus",
            literalVal: "1",
          },
          "Live Line, Dead Bus": {
            tagName: "Literal",
            name: "Live Line, Dead Bus",
            literalVal: "2",
          },
          "Dead Line, Live Bus": {
            tagName: "Literal",
            name: "Dead Line, Live Bus",
            literalVal: "3",
          },
          "Dead Line, Dead Bus OR Live Line, Dead Bus": {
            tagName: "Literal",
            name: "Dead Line, Dead Bus OR Live Line, Dead Bus",
            literalVal: "4",
          },
          "Dead Line, Dead Bus OR Dead Line, Live Bus": {
            tagName: "Literal",
            name: "Dead Line, Dead Bus OR Dead Line, Live Bus",
            literalVal: "5",
          },
          "Live Line, Dead Bus OR Dead Line, Live Bus": {
            tagName: "Literal",
            name: "Live Line, Dead Bus OR Dead Line, Live Bus",
            literalVal: "6",
          },
          "Dead Line, Dead Bus OR Live Line, Dead Bus OR Dead Line, Live Bus": {
            tagName: "Literal",
            name: "Dead Line, Dead Bus OR Live Line, Dead Bus OR Dead Line, Live Bus",
            literalVal: "7",
          },
        },
      },
  ...
  OpModSyn: {
    ...
    children: {
      ...
      stVal: {
        ...
        mandatory: true,
        presCond: "M",
        type: "SynchOperationModeKind",
        children: {
          "Automatic-synchronizing": {
            tagName: "Literal",
            name: "Automatic-synchronizing",
            literalVal: "1",
            descID:
              "IEC61850_7_4.DOEnums::SynchOperationModeKind.Automatic-synchronizing.desc",
          },
          "Automatic-paralleling": {
            tagName: "Literal",
            name: "Automatic-paralleling",
            literalVal: "2",
            descID:
              "IEC61850_7_4.DOEnums::SynchOperationModeKind.Automatic-paralleling.desc",
          },
          Manual: {
            tagName: "Literal",
            name: "Manual",
