  ...
  IntrDetMth: {
    ...
    children: {
      setVal: {
        ...
        mandatory: true,
        presCond: "M",
        type: "VoltInterruptDetectionKind",
        children: {
          Voltage: {
            tagName: "Literal",
            name: "Voltage",
          ...
          "Voltage and Normally Open breaker contact": {
            tagName: "Literal",
            name: "Voltage and Normally Open breaker contact",
            literalVal: "3",
          },
          "Voltage and Normally Closed breaker contact": {
            tagName: "Literal",
            name: "Voltage and Normally Closed breaker contact",
            literalVal: "4",
          },
          "Voltage and Normally Open and Normally Closed breaker contacts": {
            tagName: "Literal",
            name: "Voltage and Normally Open and Normally Closed breaker contacts",
            literalVal: "5",
          },
          "Normally Open breaker contact": {
            tagName: "Literal",
            name: "Normally Open breaker contact",
            literalVal: "6",
          },
          "Normally Closed breaker contact": {
            tagName: "Literal",
            name: "Normally Closed breaker contact",
            literalVal: "7",
          },
          "Both Normally Open and Normally Closed breaker contacts": {
            tagName: "Literal",
            name: "Both Normally Open and Normally Closed breaker contacts",
            literalVal: "8",
          },
        },
      },
