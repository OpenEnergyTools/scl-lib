  ...
  FuTyp: {
    ...
    children: {
      setVal: {
        ...
        mandatory: true,
        presCond: "M",
        type: "FuseFunctionKind",
        children: {
          "Slow time delay": {
            tagName: "Literal",
            name: "Slow time delay",
            literalVal: "1",
            descID:
              "IEC61850_7_4.DOEnums::FuseFunctionKind.Slow_time_delay.desc",
          },
          "Fast time delay": {
            tagName: "Literal",
            name: "Fast time delay",
            literalVal: "2",
            descID:
              "IEC61850_7_4.DOEnums::FuseFunctionKind.Fast_time_delay.desc",
          },
          "Fast acting": {
            tagName: "Literal",
            name: "Fast acting",
          ...
          "Very fast acting": {
            tagName: "Literal",
            name: "Very fast acting",
            literalVal: "4",
            descID:
              "IEC61850_7_4.DOEnums::FuseFunctionKind.Very_fast_acting.desc",
          },
