...
export const qvub = {
  UnbDetMth: {
    ...
    descID:
      "IEC61850_7_4.AbstractLNsGroupQ::UnbalanceDetectionLN.UnbDetMth.desc",
    presCond: "O",
    dsPresCond: "F",
    children: {
      setVal: {
        ...
        children: {
          ...
          "Neg-pos sequence": {
            tagName: "Literal",
            name: "Neg-pos sequence",
            literalVal: "3",
          },
          "Zero-pos sequence": {
            tagName: "Literal",
            name: "Zero-pos sequence",
            literalVal: "4",
          },
          "Phase vector comparison": {
            tagName: "Literal",
            name: "Phase vector comparison",
            literalVal: "5",
          },
          Others: {
            tagName: "Literal",
