...
export const zrrc = {
  EEName: {
    ...
    type: "DPL",
    descID:
      "IEC61850_7_4.AbstractLNsCommon::ControlEquipmentInterfaceLN.EEName.desc",
    presCond: "O",
    dsPresCond: "F",
  ...
  EEHealth: {
    ...
    descID:
      "IEC61850_7_4.AbstractLNsCommon::ControlEquipmentInterfaceLN.EEHealth.desc",
    presCond: "O",
    dsPresCond: "F",
    children: {
      stVal: {
  ...
  OpTmh: {
    ...
    type: "INS",
    descID:
      "IEC61850_7_4.AbstractLNsCommon::ControlEquipmentInterfaceLN.OpTmh.desc",
    presCond: "O",
    dsPresCond: "O",
      ...
      stVal: {
        ...
        children: {
          Stopped: {
            ...
            literalVal: "1",
            descID:
              "IEC61850_7_4.DOEnums::RotatingMachineStateKind.Stopped.desc",
          },
          Stopping: {
            tagName: "Literal",
            name: "Stopping",
          ...
          Started: {
            ...
            literalVal: "3",
            descID:
              "IEC61850_7_4.DOEnums::RotatingMachineStateKind.Started.desc",
          },
          Starting: {
            tagName: "Literal",
            name: "Starting",
