      ...
      setVal: {
        ...
        children: {
          ...
          "Both current and breaker status": {
            tagName: "Literal",
            name: "Both current and breaker status",
            literalVal: "3",
          },
          Other: {
            tagName: "Literal",
    ...
    children: {
      setVal: {
        ...
        children: {
          ...
          "With Current Check": {
            tagName: "Literal",
            name: "With Current Check",
            literalVal: "3",
          },
          "With Breaker Status Check": {
            tagName: "Literal",
            name: "With Breaker Status Check",
            literalVal: "4",
          },
          "With Current and Breaker Status Check": {
            tagName: "Literal",
            name: "With Current and Breaker Status Check",
            literalVal: "5",
          },
          "Other Checks": {
            tagName: "Literal",
