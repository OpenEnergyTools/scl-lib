        ...
        <Server>
            <LDevice inst="someLDInst">
                <LN0 lnClass="LLN0" inst="" lnType="someLnType">
                    ...
                    <SampledValueControl name="someSmv" datSet="smvDataSet1" confRev="10001" />
                    <SampledValueControl name="someSmv2" datSet="smvDataSet1" confRev="1" />
                    <SampledValueControl name="someSmv3" datSet="smvDataSet2" confRev="20001" />
                </LN0>
            </LDevice>
        </Server>
    </AccessPoint>
