export const sourceControlBlockDoc = `<?xml version="1.0" encoding="UTF-8"?>
<SCL xmlns="http://www.iec.ch/61850/2003/SCL" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" version="2007" revision="B" release="4">
	...
	<IED name="Report_Publisher" desc="Report publisher" manufacturer="Dummy">
		<AccessPoint name="AP1">
			<Server>
				<Authentication/>
				<LDevice inst="QB1_Disconnector">
					<LN0 lnClass="LLN0" inst="" lnType="Dummy.LLN0" desc="Nematoda">
						<DataSet name="GOOSE2sDataSet">
							<FCDA ldInst="QB2_Disconnector" prefix="" lnClass="CSWI" lnInst="1" doName="Pos" daName="stVal" fc="ST"/>
							<FCDA ldInst="QB2_Disconnector" prefix="" lnClass="CSWI" lnInst="1" doName="Pos" daName="q" fc="ST"/>
						</DataSet>
						<ReportControl name="rpLNInst1" datSet="GOOSE2sDataSet" rptID="QB1_Disconnector/LLN0$BR$brcbGOOSE2sDataSett" confRev="1" buffered="true">
							<TrgOps dchg="true" period="true"/>
							<OptFields seqNum="true" timeStamp="true" dataSet="true" reasonCode="true" dataRef="true" entryID="true" configRef="true" bufOvfl="false"/>
							<RptEnabled max="16"/>
						</ReportControl>
					</LN0>
				</LDevice>
				<LDevice inst="QB2_Disconnector" desc="Animalia">
					<LN0 lnClass="LLN0" inst="" lnType="Dummy.LLN0">
						...
						<ReportControl name="reportInLN0" datSet="GOOSE1sDataSet" rptID="QB2_Disconnector/LLN0$BR$brcbGOOSE1sDataSet" confRev="1" buffered="true">
							<TrgOps dchg="true" period="true"/>
							<OptFields seqNum="true" timeStamp="true" dataSet="true" reasonCode="true" dataRef="true" entryID="true" configRef="true" bufOvfl="false"/>
							<RptEnabled max="16"/>
						</ReportControl>
					...
					<LN prefix="" lnClass="CILO" inst="1" lnType="Dummy.CILO" desc="Chordata"/>
					<LN lnClass="CSWI" inst="1" lnType="Dummy.CSWI" desc="Arthropoda"/>
					<LN prefix="Stuff" lnClass="XSWI" inst="1" lnType="Dummy.XSWI" desc="Nematoda">
						<DataSet name="GOOSE2sDataSet">
							<FCDA ldInst="QB2_Disconnector" prefix="" lnClass="CSWI" lnInst="1" doName="Pos" daName="stVal" fc="ST"/>
							<FCDA ldInst="QB2_Disconnector" prefix="" lnClass="CSWI" lnInst="1" doName="Pos" daName="q" fc="ST"/>
						</DataSet>
						<ReportControl name="reportInLN" datSet="GOOSE2sDataSet" rptID="QB2_Disconnector/LLN0$BR$brcbGOOSE2sDataSett" confRev="1" buffered="true">
							<TrgOps dchg="true" period="true"/>
							<OptFields seqNum="true" timeStamp="true" dataSet="true" reasonCode="true" dataRef="true" entryID="true" configRef="true" bufOvfl="false"/>
							<RptEnabled max="16"/>
						</ReportControl>
					</LN>
					<LN prefix="" lnClass="XSWI" inst="2" lnType="Dummy.XSWI" desc="Nematoda">
						<DataSet name="GOOSE2sDataSet">
							<FCDA ldInst="QB2_Disconnector" prefix="" lnClass="CSWI" lnInst="1" doName="Pos" daName="stVal" fc="ST"/>
							<FCDA ldInst="QB2_Disconnector" prefix="" lnClass="CSWI" lnInst="1" doName="Pos" daName="q" fc="ST"/>
						</DataSet>
						<ReportControl name="rpLNPrefix1" datSet="GOOSE2sDataSet" rptID="QB2_Disconnector/LLN0$BR$brcbGOOSE2sDataSett" confRev="1" buffered="true">
							<TrgOps dchg="true" period="true"/>
							<OptFields seqNum="true" timeStamp="true" dataSet="true" reasonCode="true" dataRef="true" entryID="true" configRef="true" bufOvfl="false"/>
							<RptEnabled max="16"/>
						</ReportControl>
					</LN>
					<LN lnClass="XSWI" inst="3" lnType="Dummy.XSWI" desc="Nematoda">
						<DataSet name="GOOSE2sDataSet">
							<FCDA ldInst="QB2_Disconnector" prefix="" lnClass="CSWI" lnInst="1" doName="Pos" daName="stVal" fc="ST"/>
							<FCDA ldInst="QB2_Disconnector" prefix="" lnClass="CSWI" lnInst="1" doName="Pos" daName="q" fc="ST"/>
						</DataSet>
						<ReportControl name="rpLNPrefix2" datSet="GOOSE2sDataSet" rptID="QB2_Disconnector/LLN0$BR$brcbGOOSE2sDataSett" confRev="1" buffered="true">
							<TrgOps dchg="true" period="true"/>
							<OptFields seqNum="true" timeStamp="true" dataSet="true" reasonCode="true" dataRef="true" entryID="true" configRef="true" bufOvfl="false"/>
							<RptEnabled max="16"/>
						</ReportControl>
		...
		<AccessPoint name="AP1">
			<Server>
				...
				<LDevice inst="Earth_Switch">
					<LN0 lnClass="LLN0" inst="" lnType="Dummy.LLN0">
						<Inputs>
							<ExtRef iedName="GOOSE_Publisher" ldInst="QB2_Disconnector" lnClass="CSWI" lnInst="1" prefix="" doName="Pos" daName="stVal" srcLDInst="QB2_Disconnector" srcPrefix="" srcLNClass="LLN0" srcCBName="GOOSE2" serviceType="GOOSE" intAddr="hasServiceType1"/>
							<ExtRef iedName="GOOSE_Publisher" ldInst="QB2_Disconnector" lnClass="CSWI" lnInst="1" prefix="" doName="Pos" daName="stVal" srcLDInst="QB2_Disconnector" srcPrefix="" srcLNClass="LLN0" srcCBName="GOOSE2" intAddr="noServiceType1"/>
							<ExtRef iedName="GOOSE_Publisher" ldInst="QB2_Disconnector" lnClass="CSWI" lnInst="1" prefix="" doName="Pos" daName="stVal" srcLDInst="QB2_Disconnector" srcPrefix="" srcLNClass="LLN0" srcCBName="GOOSE2" pServT="GOOSE" intAddr="hasServiceType2"/>
							<ExtRef iedName="GOOSE_Publisher" ldInst="QB2_Disconnector" lnClass="CSWI" lnInst="1" prefix="" doName="Pos" daName="stVal" srcPrefix="" srcLNClass="LLN0" srcCBName="GOOSE2" serviceType="GOOSE" intAddr="usingLDInst"/>
							<ExtRef ldInst="QB2_Disconnector" lnClass="CSWI" lnInst="1" prefix="" doName="Pos" daName="stVal" srcLDInst="QB2_Disconnector" srcPrefix="" srcLNClass="LLN0" srcCBName="GOOSE2" serviceType="GOOSE" intAddr="missingIEDName"/>
							<ExtRef iedName="GOOSE_Publisher" lnClass="CSWI" lnInst="1" prefix="" doName="Pos" daName="stVal" srcPrefix="" srcLNClass="LLN0" srcCBName="GOOSE2" intAddr="missingLDInst"/>
							<ExtRef iedName="GOOSE_Publisher" ldInst="QB2_Disconnector" lnClass="CSWI" lnInst="1" prefix="" doName="Pos" daName="stVal" srcLDInst="QB2_Disconnector" srcPrefix="" srcLNClass="LLN0" serviceType="GOOSE" intAddr="noSrcCBName"/>
							<ExtRef iedName="GOOSE_Publisher" ldInst="QB2_Disconnector" lnClass="CSWI" lnInst="1" prefix="" doName="Pos" daName="stVal" srcLDInst="QB2_Disconnector" srcPrefix="" srcLNClass="LLN0" srcCBName="GOOSE2" serviceType="Poll" intAddr="Poll1"/>
							<ExtRef iedName="GOOSE_Publisher" ldInst="QB2_Disconnector" lnClass="CSWI" lnInst="1" prefix="" doName="Pos" daName="stVal" srcLDInst="QB2_Disconnector" srcPrefix="" srcLNClass="LLN0" srcCBName="GOOSE2" pServT="Poll" intAddr="Poll2"/>
							<ExtRef iedName="GOOSE_Publisher" ldInst="QB2_Disconnector" lnClass="CSWI" lnInst="1" prefix="" doName="Pos" daName="stVal" srcLDInst="QB2_Disconnector" srcPrefix="" srcCBName="GOOSE2" pServT="GOOSE" intAddr="hasNolnClass"/>
							<ExtRef iedName="GOOSE_Publisher" ldInst="QB2_Disconnector" lnClass="CSWI" lnInst="1" prefix="" doName="Pos" daName="stVal" srcLDInst="QB2_Disconnector" srcPrefix="" srcCBName="GOOSE2" pServT="GOOSE" intAddr="hasSrcLNInst"/>
							<ExtRef iedName="GOOSE_Publisher" ldInst="QB2_Disconnector" lnClass="CSWI" lnInst="1" prefix="" doName="Pos" daName="stVal" srcLDInst="QB2_Disconnector" srcCBName="GOOSE2" pServT="GOOSE" intAddr="hasNoSrcPrefix"/>
							<ExtRef iedName="GOOSE_Publisher2" serviceType="GOOSE" ldInst="QB2_Disconnector" lnClass="CSWI" lnInst="1" prefix="" doName="Pos" daName="stVal" srcLDInst="QB2_Disconnector" srcPrefix="" srcLNClass="LLN0" srcCBName="GOOSE2" intAddr="gseCtrlHasNoPrefix"/>
	...
	<IED name="SMV_Subscriber" manufacturer="Dummy">
		<Services>
				...
				<LDevice inst="Overvoltage">
					...
					<LN prefix="" lnClass="PTRC" inst="1" lnType="Summy.PTRC">
						<Inputs>
							...
							<ExtRef intAddr="AmpSv;TCTR2/AmpSv/instMag.i" desc="MeasPoint.CT2" iedName="SMV_Publisher" ldInst="CurrentTransformer" prefix="L3" lnClass="TCTR" lnInst="3" doName="AmpSv" daName="instMag.i" srcLDInst="SomethingElse" srcPrefix="" srcLNClass="LLN0" srcCBName="fullSmv" serviceType="SMV"/>
							<ExtRef intAddr="AmpSv;TCTR2/AmpSv/q" desc="MeasPoint.CT1"/>
							<ExtRef intAddr="SMVhasServiceType1" desc="MeasPoint.CT3" iedName="SMV_Publisher" ldInst="CurrentTransformer" prefix="L3" lnClass="TCTR" lnInst="3" doName="AmpSv" daName="instMag.i" srcLDInst="CurrentTransformer" srcPrefix="" srcLNClass="LLN0" srcCBName="fullSmv" serviceType="SMV"/>
							...
							<ExtRef intAddr="SMVhasNoServiceType1" desc="MeasPoint.CT3" iedName="SMV_Publisher" ldInst="CurrentTransformer" prefix="L3" lnClass="TCTR" lnInst="3" doName="AmpSv" daName="instMag.i" srcLDInst="CurrentTransformer" srcPrefix="" srcLNClass="LLN0" srcCBName="fullSmv"/>
							<ExtRef intAddr="SMVhasServiceType2" desc="MeasPoint.CT3" iedName="SMV_Publisher" ldInst="CurrentTransformer" prefix="L3" lnClass="TCTR" lnInst="3" doName="AmpSv" daName="instMag.i" srcLDInst="CurrentTransformer" srcPrefix="" srcLNClass="LLN0" srcCBName="fullSmv" pServT="SMV"/>
							<ExtRef intAddr="SMVhasNoSrcLDInst" desc="MeasPoint.CT3" iedName="SMV_Publisher" ldInst="CurrentTransformer" prefix="L3" lnClass="TCTR" lnInst="3" doName="AmpSv" daName="instMag.i" srcPrefix="" srcLNClass="LLN0" srcCBName="fullSmv" serviceType="SMV"/>
							<ExtRef intAddr="SMVhasNoIedName" desc="MeasPoint.CT3" ldInst="CurrentTransformer" prefix="L3" lnClass="TCTR" lnInst="3" doName="AmpSv" daName="instMag.i" srcLDInst="CurrentTransformer" srcPrefix="" srcLNClass="LLN0" srcCBName="fullSmv" serviceType="SMV"/>
							<ExtRef intAddr="SMVmissingLDInst" desc="MeasPoint.CT3" iedName="SMV_Publisher" prefix="L3" lnClass="TCTR" lnInst="3" doName="AmpSv" daName="instMag.i" srcPrefix="" srcLNClass="LLN0" srcCBName="fullSmv" serviceType="SMV"/>
							<ExtRef intAddr="SMVmissingCBName" desc="MeasPoint.CT3" iedName="SMV_Publisher" ldInst="CurrentTransformer" prefix="L3" lnClass="TCTR" lnInst="3" doName="AmpSv" daName="instMag.i" srcLDInst="CurrentTransformer" srcPrefix="" srcLNClass="LLN0" serviceType="SMV"/>
							<ExtRef intAddr="SMVhasNoLnClass" desc="MeasPoint.CT3" iedName="SMV_Publisher" ldInst="CurrentTransformer" prefix="L3" lnClass="TCTR" lnInst="3" doName="AmpSv" daName="instMag.i" srcLDInst="CurrentTransformer" srcPrefix="" srcCBName="fullSmv" serviceType="SMV"/>
							<ExtRef intAddr="SMVhasNoSrcPrefix" desc="MeasPoint.CT3" iedName="SMV_Publisher" ldInst="CurrentTransformer" prefix="L3" lnClass="TCTR" lnInst="3" doName="AmpSv" daName="instMag.i" srcLDInst="CurrentTransformer" srcLNClass="LLN0" srcCBName="fullSmv" serviceType="SMV"/>
						</Inputs>
					</LN>
				</LDevice>
	...
	<IED name="Report_Subscriber" manufacturer="Dummy">
		<AccessPoint name="AP1">
			<Server>
				<Authentication/>
				<LDevice inst="Earth_Switch">
					<LN0 lnClass="LLN0" inst="" lnType="Dummy.LLN0">
						<Inputs>
							<ExtRef iedName="Report_Publisher" ldInst="QB2_Disconnector" lnClass="XSWI" lnInst="1" prefix="Stuff" doName="Pos" daName="stVal" srcLDInst="QB2_Disconnector" srcPrefix="Stuff" srcLNClass="XSWI" srcLNInst="1" srcCBName="reportInLN" serviceType="Report" intAddr="ReportHasServiceType1"/>
							<ExtRef iedName="Report_Publisher" ldInst="QB2_Disconnector" lnClass="XSWI" lnInst="1" prefix="Stuff" doName="Pos" daName="stVal" srcLDInst="QB2_Disconnector" srcPrefix="Stuff" srcLNClass="XSWI" srcLNInst="1" srcCBName="reportInLN" pServT="Report" intAddr="ReportHasServiceType2"/>
							<ExtRef iedName="Report_Publisher" ldInst="QB2_Disconnector" lnClass="XSWI" lnInst="1" prefix="Stuff" doName="Pos" daName="stVal" srcLDInst="QB2_Disconnector" srcPrefix="Stuff" srcLNClass="XSWI" srcLNInst="1" srcCBName="reportInLN" intAddr="ReportHasNoServiceType"/>
							<ExtRef iedName="Report_Publisher" ldInst="QB2_Disconnector" lnClass="XSWI" lnInst="1" prefix="Stuff" doName="Pos" daName="stVal" srcPrefix="Stuff" srcLNClass="XSWI" srcLNInst="1" srcCBName="reportInLN" serviceType="Report" intAddr="ReportHasNosrcLDInst"/>
							<ExtRef iedName="Report_Publisher" ldInst="QB2_Disconnector" lnClass="CSWI" lnInst="1" prefix="Stuff" doName="Pos" daName="stVal" srcPrefix="" srcLNClass="LLN0" srcCBName="reportInLN0" serviceType="Report" intAddr="ReportCBinLN0"/>
							<ExtRef ldInst="QB2_Disconnector" lnClass="CSWI" lnInst="1" prefix="Stuff" doName="Pos" daName="stVal" srcPrefix="" srcLNClass="LLN0" srcCBName="reportInLN0" serviceType="Report" intAddr="ReportMissingIEDName"/>
							<ExtRef iedName="Report_Publisher" lnClass="XSWI" lnInst="1" prefix="Stuff" doName="Pos" daName="stVal" srcPrefix="Stuff" srcLNClass="XSWI" srcLNInst="1" srcCBName="reportInLN" serviceType="Report" intAddr="ReportHasNoLDInst"/>
							<ExtRef iedName="Report_Publisher" lnClass="XSWI" lnInst="1" prefix="Stuff" doName="Pos" daName="stVal" srcPrefix="Stuff" srcLNClass="XSWI" srcLNInst="1" srcCBName="reportInLN" serviceType="Report" intAddr="ReportHasNoSrcCBName"/>
							<ExtRef iedName="Report_Publisher" ldInst="QB2_Disconnector" lnClass="XSWI" lnInst="1" prefix="Stuff" doName="Pos" daName="stVal" srcLDInst="QB2_Disconnector" srcPrefix="Stuff" srcLNClass="XSWI" srcLNInst="1" srcCBName="reportInLNWr" serviceType="Report" intAddr="ReportHasWrongSrcCBName"/>
							<ExtRef iedName="Report_Publisher" ldInst="QB2_Disconnector" lnClass="XSWI" lnInst="3" prefix="" doName="Pos" daName="stVal" srcLDInst="QB2_Disconnector" srcLNClass="XSWI" srcLNInst="3" srcCBName="rpLNPrefix2" serviceType="Report" intAddr="ReportHasEmptyStrSrcLNInst2"/>
							<ExtRef iedName="Report_Publisher" ldInst="QB2_Disconnector" lnClass="XSWI" lnInst="3" prefix="" doName="Pos" daName="stVal" srcLDInst="QB2_Disconnector" srcLNClass="XSWI" srcLNInst="2" srcCBName="rpLNPrefix1" serviceType="Report" intAddr="ReportHasEmptyStrSrcLNInst3"/>
							<ExtRef iedName="Report_Publisher" ldInst="QB2_Disconnector" lnClass="XSWI" lnInst="2" prefix="" doName="Pos" daName="stVal" srcLDInst="QB2_Disconnector" srcLNClass="XSWI" srcLNInst="3" srcCBName="rpLNPrefix2" srcPrefix="" serviceType="Report" intAddr="ReportHasEmptyStrSrcLNInst4"/>
							<ExtRef iedName="Report_Publisher" ldInst="QB2_Disconnector" lnClass="XSWI" lnInst="3" prefix="" doName="Pos" daName="stVal" srcLDInst="QB2_Disconnector" srcLNClass="XSWI" srcLNInst="2" srcCBName="rpLNPrefix1" srcPrefix="" serviceType="Report" intAddr="ReportHasEmptyStrSrcLNInst5"/>
						</Inputs>
					</LN0>
				</LDevice>
			</Server>
